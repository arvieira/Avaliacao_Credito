...
with my_expander_1:
    ...
    dict_respostas['Rendimento_Anual'] = col2_form.slider('Qual o salário mensal ?',
...
with my_expander_2:
    ...
    dict_respostas['Idade'] = col4_form.slider('Qual a idade ?',
                                               help='Podemos mover a barra usando as setas do teclado', min_value=0,
...
with my_expander_3:
    ...
    dict_respostas['Tamanho_Familia'] = col6_form.slider('Qual o tamaho da família ?',
                                                         help='Podemos mover a barra usando as setas do teclado',
                                                         min_value=1, max_value=20, step=1)
    dict_respostas['Qtd_Filhos'] = col6_form.slider('Quantos filhos ?',
                                                    help='Podemos mover a barra usando as setas do teclado',
